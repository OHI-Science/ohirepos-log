...
# Before R: First create repo on GitHub.com and register repo
...
## TODO: set warning if MAZU not mounted
if (any(stringr::str_detect(repo_registry, 'git-annex'))) {
  ## mazu directories
...
ohirepos::calculate_scores_check(repo_registry, ohicore_version = 'ohicore@dev')
