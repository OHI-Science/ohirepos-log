...
## create explore-global.Rmd. Requires connection to NCEAS's server
...
## NOTE!! must remove by hand between: ## Reference Point Accounting ## Reference Point End. Code at a later date
